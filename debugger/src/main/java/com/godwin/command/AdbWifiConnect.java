...
public class AdbWifiConnect {
    ...
    private static DeviceResult getDevice(Project project) {
        ...
        if (!facets.isEmpty()) {
            ...
            if (bridge == null) {
                System.out.println("No platform configured");
                return null;
            }
            int count = 0;
            while (!bridge.isConnected() || !bridge.hasInitialDeviceList()) {
                ...
                if (count > 100) {
                    System.out.println("Timeout getting device list!");
                    return null;
                }
            }
            ...
            if (devices.length == 1) {
                ...
                return null;/*askUserForDevice(facet, packageName);*/
            } else {
                return null;
            }
